...
const ActionNode: React.FC<NodeProps> = ({ id, data }) => {
  ...
  return (
    <div className="bg-green-100 border-2 border-green-500 text-green-900 rounded-lg p-3 min-w-[120px] relative group">
      {/* Type Badge */}
      ...
      <div onDoubleClick={handleDoubleClick} className="cursor-pointer">
        {isEditing ? (
          <input
            ...
            className="w-full bg-transparent border-none outline-none text-green-900 font-medium"
          />
        ) : (
