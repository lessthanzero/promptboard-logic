...
const OutcomeNode: React.FC<NodeProps> = ({ id, data }) => {
  ...
  return (
    <div className="bg-orange-100 border-2 border-orange-500 text-orange-900 rounded-lg p-3 min-w-[120px] relative group">
      {/* Type Badge */}
      ...
      <div onDoubleClick={handleDoubleClick} className="cursor-pointer">
        {isEditing ? (
          <input
            ...
            className="w-full bg-transparent border-none outline-none text-orange-900 font-medium"
          />
        ) : (
